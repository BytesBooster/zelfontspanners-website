-- Safe migration script to convert existing tables from camelCase to snake_case
-- This script only renames columns - no data is lost
...
-- Create indexes with correct column names (only if they don't exist)
