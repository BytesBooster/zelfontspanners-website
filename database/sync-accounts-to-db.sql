-- Synchroniseer alle accounts naar de database
-- Dit script maakt accounts aan voor alle leden die nog niet in de database staan
-- Gebruikt ON CONFLICT om te voorkomen dat bestaande accounts worden overschreven
...
-- Toon alle accounts
SELECT member_name, 
       CASE WHEN password = 'welkom2026!' THEN 'Standaard' ELSE 'Gewijzigd' END as password_status,
       created_at,
       updated_at
FROM accounts
